...
import com.data.shared.exception.QdrantOperationException;
...
public class QdrantGrpcClient {
    ...
    public QdrantGrpcClient(QdrantGrpcConfig config) {
        this.config = config;
        this.client = new QdrantClient(io.qdrant.client.QdrantGrpcClient
...
// Payload fields (THIS is the correct way)
        ...
        try {
            ...
            throw new QdrantOperationException(e.getMessage(), e);
