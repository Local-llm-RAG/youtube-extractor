...
import com.data.youtube.service.YouTubeInternalService;
...
public class QdrantProcessorService implements Job {
    ...
    private final QdrantGrpcClient qdrantGrpcClient;
...
//                });
    ...
    private EmbedTranscriptRequest buildEmbedTranscriptRequest(String transcriptText) {
        return EmbedTranscriptRequest.forPassage(transcriptText, embeddingProperties);
    }
