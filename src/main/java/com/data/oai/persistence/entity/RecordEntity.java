...
public class RecordEntity {
    ...
    private List<RecordAuthorEntity> authors = new ArrayList<>();
    ...
    public void addAuthor(RecordAuthorEntity author) {
        authors.add(author);
        author.setRecord(this);
    }

    public void removeAuthor(RecordAuthorEntity author) {
