...
import com.data.oai.persistence.repository.RecordSearchRepository;
...
public class ArxivGPTCostEstimator {
    ...
    private Stream<LangText> arxivTexts(String arxivId, SectionFilter filter) {
        RecordEntity record = recordSearchRepository.findBySourceId(arxivId).orElseThrow(() -> new ResourceNotFoundException("Arxiv record not found"));
