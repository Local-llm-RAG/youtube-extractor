...
public class ArxivGPTCostEstimator {
    ...
    public CostEstimate findAndEstimateResourceTransformationCost(
            ...
            ArxivSectionFilter arxivFilter
    ) {
    ...
    private Stream<LangText> arxivTexts(String arxivId, ArxivSectionFilter filter) {
        ArxivRecordEntity record = arxivRepository.findByArxivId(arxivId).orElseThrow(() -> new RuntimeException("Arxiv record not found"));
    ...
    private String buildFilteredPaperText(ArxivRecordEntity record, ArxivSectionFilter filter) {
        List<ArxivSectionEntity> list = getArxivSectionEntities(record, filter);
    ...
    private List<ArxivSectionEntity> getArxivSectionEntities(ArxivRecordEntity record, ArxivSectionFilter filter) {
    ...
    private String buildMetadataText(ArxivRecordEntity r) {
        return """
            TITLE: %s
